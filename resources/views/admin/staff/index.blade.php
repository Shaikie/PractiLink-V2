...
<div class="card">
    <div class="card-header d-flex align-items-center">
        ...
        <div class="ml-auto"><a href="{{ route('admin.staff.roles.index') }}" class="btn btn-outline-secondary btn-sm mr-1">Roles & Permissions</a><a href="{{ route('admin.staff.create') }}" class="btn btn-primary btn-sm">Add staff</a></div>
    </div>
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>@forelse($staff as $member)<tr>
