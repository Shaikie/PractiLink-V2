...
class ReferenceDataSeeder extends Seeder
{
    public function run(): void
    {
        $tables = [
            ...
            'document_types' => [
                ['name'=>'Introduction Letter','code'=>'INTRODUCTION','is_required'=>true,'allowed_extensions'=>json_encode(['pdf','jpg','jpeg','png','docx']),'allowed_mime_types'=>json_encode(['application/pdf','image/jpeg','image/png','application/vnd.openxmlformats-officedocument.wordprocessingml.document']),'max_size_kb'=>10240,'min_size_kb'=>10,'is_active'=>true,'description'=>'Official introduction letter. PDF, DOCX, JPG, JPEG, or PNG up to 10 MB.'],
                ['name'=>'Academic Transcript','code'=>'TRANSCRIPT','is_required'=>true,'allowed_extensions'=>json_encode(['pdf','jpg','jpeg','png','docx']),'allowed_mime_types'=>json_encode(['application/pdf','image/jpeg','image/png','application/vnd.openxmlformats-officedocument.wordprocessingml.document']),'max_size_kb'=>10240,'min_size_kb'=>10,'is_active'=>true,'description'=>'Academic transcript. PDF, DOCX, JPG, JPEG, or PNG up to 10 MB.'],
                ['name'=>'Curriculum Vitae','code'=>'CV','is_required'=>false,'allowed_extensions'=>json_encode(['pdf','jpg','jpeg','png','docx']),'allowed_mime_types'=>json_encode(['application/pdf','image/jpeg','image/png','application/vnd.openxmlformats-officedocument.wordprocessingml.document']),'max_size_kb'=>10240,'min_size_kb'=>10,'is_active'=>true,'description'=>'Optional CV. PDF, DOCX, JPG, JPEG, or PNG up to 10 MB.'],
            ],
