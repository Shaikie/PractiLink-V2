...
class RolePermissionSeeder extends Seeder
{
    ...
    {
        $permissions = [
            ['name'=>'Manage users','slug'=>'users.manage'], ['name'=>'Manage students','slug'=>'students.manage'],
            ['name'=>'Manage application windows','slug'=>'applications.manage'], ['name'=>'View applications','slug'=>'applications.view'],
            ['name'=>'Review applications','slug'=>'applications.review'], ['name'=>'Forward applications','slug'=>'applications.forward'],
            ['name'=>'Return applications for correction','slug'=>'applications.return'], ['name'=>'Reject applications','slug'=>'applications.reject'],
            ['name'=>'Accept applications','slug'=>'applications.accept'], ['name'=>'Assign supervisors','slug'=>'applications.assign_supervisor'],
            ['name'=>'Manage documents','slug'=>'applications.documents'], ['name'=>'Manage workflows','slug'=>'workflows.manage'],
            ['name'=>'Manage organizations','slug'=>'organizations.manage'], ['name'=>'Manage placements','slug'=>'placements.manage'],
            ['name'=>'Manage reports','slug'=>'reports.manage'],
        ];
        foreach ($permissions as $permission) DB::table('permissions')->updateOrInsert(['slug'=>$permission['slug']], array_merge($permission,['updated_at'=>now(),'created_at'=>now()]));
        ...
        foreach ($permissionIds->values() as $permissionId) DB::table('role_permissions')->updateOrInsert(['role_id'=>$administrator,'permission_id'=>$permissionId]);
        ...
        $rolePermissions = [
            ...
            'placement-officer' => ['applications.view','applications.review','applications.forward','applications.return','applications.assign_supervisor','applications.documents','placements.manage'],
