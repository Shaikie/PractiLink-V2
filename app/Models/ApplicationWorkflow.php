...
{
    protected $fillable = ['application_id', 'workflow_version_id', 'current_stage_id', 'assigned_user_id', 'completed_at'];
    ...
    public function duties(): HasMany { return $this->hasMany(ApplicationWorkflowDuty::class); }
}
