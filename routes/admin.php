...
Route::middleware('permission:users.manage')->prefix('staff')->name('staff.')->group(function(){Route::get('/',[AdminStaffController::class,'index'])->name('index');Route::get('/create',[AdminStaffController::class,'create'])->name('create');Route::post('/',[AdminStaffController::class,'store'])->name('store');Route::get('/{staff}/edit',[AdminStaffController::class,'edit'])->name('edit');Route::put('/{staff}',[AdminStaffController::class,'update'])->name('update');Route::get('/roles',[AdminRoleController::class,'index'])->name('roles.index');Route::post('/roles',[AdminRoleController::class,'store'])->name('roles.store');Route::put('/roles/{role}',[AdminRoleController::class,'update'])->name('roles.update');});

Route::middleware('permission:organizations.manage')->prefix('organizations')->name('organizations.')->group(function(){Route::get('/',[AdminOrganizationController::class,'index'])->name('index');Route::post('/',[AdminOrganizationController::class,'store'])->name('store');Route::put('/{organization}',[AdminOrganizationController::class,'update'])->name('update');});
Route::middleware('permission:placements.manage')->prefix('placements')->name('placements.')->group(function(){Route::get('/',[AdminPlacementController::class,'index'])->name('index');Route::get('/applications/{application}/create',[AdminPlacementController::class,'create'])->name('create');Route::post('/applications/{application}',[AdminPlacementController::class,'store'])->name('store');Route::put('/{placement}/status',[AdminPlacementController::class,'updateStatus'])->name('status.update');Route::post('/{placement}/letter',[AdminPlacementLetterController::class,'issue'])->name('letter.issue');Route::get('/letters/{letter}',[AdminPlacementLetterController::class,'show'])->name('letter.show');});
